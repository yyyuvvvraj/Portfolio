  ...
  return (
    ...
    >
      ...
      <g filter="url(#shadow)">
        ...
        {/* Graph */}
        <path
          d="M 20 60 L 35 40 L 50 55 L 65 30 L 80 50 L 80 80 L 20 80 Z"
          fill="url(#chartGlow)"
        />
        <polyline
          points="20,60 35,40 50,55 65,30 80,50"
          fill="none"
          stroke="#E10600"
          strokeWidth="3"
          strokeLinecap="round"
  ...
  return (
    ...
    >
      ...
      <g filter="url(#shadow)">
        ...
        <path
          d="M 25 40 L 50 60 L 75 40 L 75 65 C 75 68 72 70 70 70 L 30 70 C 28 70 25 68 25 65 Z"
          fill="url(#mailGrad)"
        />
        <path
          d="M 25 40 L 50 60 L 75 40 L 70 30 C 68 30 65 30 65 30 L 35 30 C 30 30 25 40 25 40 Z"
          fill="url(#mailFlap)"
        />
        <polyline
          points="25,40 50,60 75,40"
          fill="none"
          stroke="#2c85c2"
          strokeWidth="2"
          strokeLinejoin="round"
...
function FolderAppIcon({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <g filter="url(#shadow)">
        <path
          d="M 15 25 L 40 25 L 45 35 L 85 35 L 85 80 L 15 80 Z"
          fill="url(#folderBack)"
        />
        <path
          d="M 15 40 L 45 40 L 50 35 L 85 35 L 85 80 L 15 80 Z"
...
function GameAppIcon({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 100 100"
      className={className}
    ...
    >
      ...
      <g filter="url(#glow)">
        ...
        <circle cx="70" cy="30" r="5" fill="#00FFFF" opacity="0.7" />
        <circle cx="70" cy="70" r="7" fill="#FF00FF" opacity="0.8" />
        <circle cx="30" cy="70" r="5" fill="#FFFF00" opacity="0.6" />
        ...
        <circle
          ...
          opacity="0.3"
        />
        <circle cx="50" cy="50" r="8" fill="url(#quantumGrad)" opacity="0.4" />
        ...
        {/* Connecting lines - particles collection */}
        <line
          x1="50"
          y1="50"
          x2="30"
...
export default function UbuntuDock() {
  ...
  const navItems = [
    ...
    {
      path: "/telemetry",
      IconComponent: SysMonitorAppIcon,
      label: "Telemetry (System Monitor)",
      type: "component",
    },
    {
      path: "/projects",
      ...
      label: "Projects (Browser)",
      type: "image",
    },
    {
      path: "/game",
      IconComponent: GameAppIcon,
      label: "Territory Wars (Game)",
      type: "component",
    },
    {
      path: "/logs",
      IconComponent: TerminalAppIcon,
      label: "Operation Logs (Terminal)",
      type: "component",
    },
    {
      path: "/contact",
      IconComponent: MailAppIcon,
      label: "Secure Channel (Comms)",
      type: "component",
    },
    {
      path: "/downloads",
      IconComponent: FolderAppIcon,
      label: "Secure Downloads (Files)",
      type: "component",
    },
  ];
  ...
  return (
    <div className="fixed left-0 md:top-7 bottom-0 w-full md:w-16 h-16 md:h-[calc(100vh-1.75rem)] bg-[#300a24]/80 backdrop-blur-md border-t md:border-t-0 md:border-r border-[#E10600]/30 flex flex-row md:flex-col items-center justify-center md:justify-start py-2 md:py-4 px-4 md:px-0 gap-2 sm:gap-4 z-40">
      {navItems.map((item) => {
        ...
        const routeKey =
          item.path === "/" ? "home" : (item.path.slice(1) as any);
        ...
        return (
          <Link
            ...
            className={`relative p-2 rounded-2xl transition-all group cyber-border ${
              isActive
                ? "bg-white/20 shadow-[0_4px_15px_rgba(0,0,0,0.3)]"
                : "hover:bg-white/10"
            }`}
            title={item.label}
          >
            ...
            {item.type === "image" ? (
              <img
                src={item.iconUrl}
                alt={item.label}
                className="w-8 h-8 object-contain drop-shadow-lg hover:scale-110 transition-transform duration-200"
              />
            ) : item.IconComponent ? (
